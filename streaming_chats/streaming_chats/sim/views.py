...
from . import models
import json
from .signals import message_queue
import random
...
def lobby(request: HttpRequest) -> HttpResponse:
    if request.method == 'POST':
        ...
        if username:
            ...
            names = [
                "Horatio", "Benvolio", "Mercutio", "Lysander", 
                "Demetrius", "Sebastian", "Orsino",
                "Malvolio", "Hero", "Bianca", "Gratiano", 
                "Feste", "Antonio", "Lucius", "Puck", "Lucio",
